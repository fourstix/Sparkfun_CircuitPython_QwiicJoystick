...
* **/doc** - Documentation files for the library (auto-generated).
* **sparkfun_qwiicJoystick.py** - Source file for the library.
...
* TODO: Copy Adafruit template information here.

Installation
------------
* TODO:  Release to CircuitPython community and update with instructions on how to install via pip3.
